...
def markAttendance(name, path):
    with open(f'{path}', 'r+') as f:
        ...
        if name not in nameList:
            ...
            f.writelines(f'\n{name}')
            # receiver = "faizfarooq3333@gmail.com"
            # body = "Attendance"
            # filename = "E:/project/Code/HOG SVM/AttendanceImage.csv"
            #
            # yag = yagmail.SMTP("faiz.19b151027@abes.ac.in", "faiz6aug")
            # yag.send(
            #     to=receiver,
            #     subject="Attendance",
            #     contents=body,
            ...
            #
            # )
        yag = yagmail.SMTP("faiz.19b151027@abes.ac.in",
                               "faiz6aug")


        yag.send("faizfarooq3333@gmail.com", "Atten", "Content Of Mail",
                     attachments="E:/project/Code/HOG SVM/AttendanceImage.csv")
